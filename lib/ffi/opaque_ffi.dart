...
class Opaque extends OpaqueInterface {
  ...
  void _check_api_ret(int ret) {
    if (ret != 0) {
      throw OpaqueException("API call failed");
    }
  }
  ...
  RegisterResult Register(Uint8List pwd, OpaqueIds ids,
    ...
    _check_api_ret(ret);
    return RegisterResult(rec_value, export_key_value);
  }
  ...
  CreateCredentialRequestResult CreateCredentialRequest(Uint8List pwd) {
    ...
    _check_api_ret(ret);
    return CreateCredentialRequestResult(sec_value, pub_value);
  }
  ...
  CreateCredentialResponseResult CreateCredentialResponse(
    ...
    _check_api_ret(ret);
    return CreateCredentialResponseResult(resp_value, sk_value, authU_value);
  }
  ...
  RecoverCredentialsResult RecoverCredentials(
    ...
    _check_api_ret(ret);
    return RecoverCredentialsResult(sk_value, authU_value, export_key_value);
  }
  ...
  CreateRegistrationRequestResult CreateRegistrationRequest(Uint8List pwd) {
    ...
    _check_api_ret(ret);
    return CreateRegistrationRequestResult(sec_value, request_value);
  }
  ...
  CreateRegistrationResponseResult CreateRegistrationResponse(Uint8List request,
    ...
    _check_api_ret(ret);
    return CreateRegistrationResponseResult(sec_value, pub_value);
  }
  ...
  StoreUserRecordResult StoreUserRecord(Uint8List sec, Uint8List recU) {
    ...
    return StoreUserRecordResult(rec_value);
  }
}
